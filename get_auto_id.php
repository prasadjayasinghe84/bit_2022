...
<html>
    ...
    <body>
            ...
            <div class="row">
                <form>
                    ...
                    <div class="mb-3 row">
                        ...
                        <button type="button" class="btn btn-primary col-md-6 d-print-none" id="save"><i class="bi bi-save"> Save</i> </button>
        ...
        <script src="js/get_auto_id.js" type="text/javascript"></script>
